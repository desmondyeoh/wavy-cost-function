...
![Img](plot.png)
*Screenshot from the Coursera Machine Learning course*

The Jupyter notebook proves that that using squared error cost function for logistic regression will indeed cause non-convex wavy-like cost function.
